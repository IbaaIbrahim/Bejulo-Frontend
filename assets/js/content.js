...
window.BEJULO_CONTENT = {
  ...
  en: {
    ...
    'careers.job.tv.title': 'Technical Manager Ground-Mounted PV and BESS (m/f/d)',
    'careers.job.tv.desc': '<p class="job-meta">We are looking for someone to join our team in Mainz-Hechtsheim, Germany at the earliest possible date:</p><p class="job-subtitle">Full-time</p><h4>Who we are: bejulo GmbH</h4><p>bejulo GmbH is a company with over 13 years of experience in the development, engineering, construction and operation of utility-scale ground-mounted PV systems and BESS. With currently 20 employees, we operate internationally with a focus on project development in Germany. On our path to becoming an IPP, we also hold several assets in our own portfolio or together with partners.</p><h4>What you can expect:</h4><ul><li>A forward-looking workplace in a dynamic company with flat hierarchies, a pleasant working atmosphere, and a collaborative team</li><li>A position of high responsibility</li><li>A varied and engaging field of tasks</li></ul><h4>What we look for in you:</h4><ul><li>Strong teamwork and interpersonal skills</li><li>Independent working style and high reliability</li><li>Excellent communication skills</li><li>Willingness to travel (approx. 65%) including intercultural competence</li></ul><h4>Your responsibilities include:</h4><ul><li>Technical management and supervision of solar and BESS projects across all phases (planning, construction, commissioning, handover, and operational phase)</li><li>Technical optimization of the plant regarding local and customer requirements</li><li>Supporting project management with regard to the economic viability of utilized components</li><li>Plant engineering and design from initial layout in the tender phase through detailed execution planning to &ldquo;As-Built&rdquo; documentation for PV and BESS</li><li>Coordination and implementation of grid connections with on-site and normative requirements</li><li>Preparation of bills of quantities / tender specifications</li><li>Briefing and coordination of site management and subcontractors on the respective project (construction site experience is an advantage)</li></ul><h4>Professional skills &amp; qualifications:</h4><ul><li>Solid experience in the field of photovoltaic systems (ideally also proficient with CAD, PVsyst)</li><li>Proficient in standard Office applications</li><li>Very good written and spoken English skills</li></ul><h4>Interested in joining our team?</h4><p>Then we look forward to receiving your application! Please send your documents by email to: <a href="mailto:bewerbung@bejulo.de"><strong>bewerbung@bejulo.de</strong></a>. Your contact person is Peter R&uuml;ggeberg.</p><div class="job-footer"><p>Further information about our company, details on authorized representatives, as well as data privacy and processing can be found on our website: <a href="imprint.html">Legal Notice</a> and <a href="privacy.html">Privacy Policy</a>.</p><p><strong>bejulo GmbH</strong> &bull; Dekan-Laist-Stra&szlig;e 15a &bull; 55129 Mainz, Germany &bull; Phone: <a href="tel:+4961312151400">+49(0)6131-2151 400</a> &bull; <a href="index.html">www.bejulo.de</a></p></div>'
  },
  ...
  de: {
    ...
    'careers.job.tv.title': 'Technischer Verantwortlicher PV-Freifläche und BESS (m/w/d)',
    'careers.job.tv.desc': '<p class="job-meta">Wir suchen zum nächstmöglichen Zeitpunkt in Mainz-Hechtsheim:</p><p class="job-subtitle">in Vollzeit</p><h4>Das sind wir: bejulo GmbH</h4><p>Die bejulo GmbH ist ein Unternehmen mit über 13 Jahren Erfahrung in der Entwicklung, Planung, Umsetzung und Betrieb von großen PV-Freiflächenanlagen und BESS. Mit derzeit 20 Mitarbeitenden sind wir international unterwegs mit dem Schwerpunkt Deutschland in der Projektentwicklung. Auf dem Weg zum IPP halten wir einige der Assets auch im eigenen Bestand oder zusammen mit Partnern.</p><h4>Das dürfen Sie erwarten:</h4><ul><li>einen zukunftsorientierten Arbeitsplatz in einem dynamischen Unternehmen mit flachen Hierarchien und einer angenehmen Arbeitsatmosphäre sowie kollegialem Team</li><li>eine verantwortungsvolle Tätigkeit</li><li>ein abwechslungsreiches Aufgabenfeld</li></ul><h4>Das wünschen wir uns von Ihnen:</h4><ul><li>eine sehr gute Teamfähigkeit</li><li>eine selbstständige Arbeitsweise und Zuverlässigkeit</li><li>eine sehr gute Kommunikationsfähigkeit</li><li>Reisebereitschaft (65%) inkl. interkultureller Kompetenz</li></ul><h4>Zu Ihren Aufgaben gehören:</h4><ul><li>die technische Betreuung des Solar- und BESS-Projektes in allen Phasen (Planung, Errichtung, Inbetriebnahme, Übergabe und Betriebsphase)</li><li>die technische Optimierung der Anlage hinsichtlich lokaler und Kundenanforderungen</li><li>die Unterstützung des Projektmanagements hinsichtlich der Wirtschaftlichkeit eingesetzter Komponenten</li><li>die Anlagenplanung vom ersten Layout in der Angebotsphase über die Ausführungsplanung bis zur „As Built-Dokumentation“ von PV und BESS</li><li>die Koordination und Umsetzung des Netzanschlusses mit den Gegebenheiten (Vorort, Normativ, …)</li><li>die Erstellung von Leistungsverzeichnissen</li><li>die Einweisung und Koordination der Bauleitung und Subunternehmer in dem jeweiligen Projekt (Baustellenerfahrung vorteilhaft)</li></ul><h4>Fachliche Fähigkeiten:</h4><ul><li>Sie haben bereits gute Erfahrungen im Bereich der Photovoltaikanlagen gesammelt (idealerweise auch im Umgang mit CAD, PV Syst)</li><li>Sie haben einen sicheren Umgang mit den gängigen Office-Anwendungen</li><li>Sie besitzen sehr gute englische Sprachkenntnisse in Wort und Schrift</li></ul><h4>Haben wir Ihr Interesse geweckt?</h4><p>Dann freuen wir uns auf Ihre aussagekräftige Bewerbung. Diese richten Sie bitte per E-Mail an: <a href="mailto:bewerbung@bejulo.de"><strong>bewerbung@bejulo.de</strong></a>. Ihr Ansprechpartner ist Peter Rüggeberg.</p><div class="job-footer"><p>Weitere Informationen zu unserem Unternehmen, Angaben zu den vertretungsberechtigten Personen sowie zum Datenschutz und der Datenverarbeitung finden Sie hier auf unserer Internetseite: <a href="imprint.html">Impressum</a> sowie <a href="privacy.html">Datenschutzerklärung</a>.</p><p><strong>bejulo GmbH</strong> • Dekan-Laist-Straße 15a • 55129 Mainz • Tel: <a href="tel:+4961312151400">+49(0)6131-2151 400</a> • <a href="index.html">www.bejulo.de</a></p></div>'
  }
};
